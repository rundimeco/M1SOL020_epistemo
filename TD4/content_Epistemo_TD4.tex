...
\begin{itemize}
  \item D'après le texte ci-dessus, construisez un message crypté à partir d'un code "numéro de ligne-numéro de caractère", où chaque symbole du code sera unique.
  \item Améliorez le cryptage avec une substitution homophonique, rédigez l'algorithme.
\end{itemize}
